...
class CellManager{
    ...
    public function initCells($cells){
        ...
        foreach($cells as $key => $value){
            $this->createCell($key, $value['date'], $value['x1'], $value['x2'], $value['y'], $value['y2'], $value['z1'], $value['z2'], $value['level'], $value['price'], $value['days']);
            if($value['owner'] != null){
    ...
    public function createCell($name, $date, $x1, $x2, $y, $y2, $z1, $z2, $level, $price, $days = null){
        if(($price == null) || ($price == '')){
        ...
        $this->cells[$name] = new Cell($name, $date, $x1, $x2, $y, $y2, $z1, $z2, $level, $price, $days);
    }
