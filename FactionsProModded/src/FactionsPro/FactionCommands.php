...
class FactionCommands implements CommandExecutor {
        ...
        if ($sender instanceof Player) {
            ...
            if (strtolower($command->getName()) === "f") {
	            ...
	            if (strtolower($args[0]) == 'claim') {
		            ...
		            if(!$this->plugin->isHomeSet($this->plugin->getFaction($playerName))) {
			            $sender->sendMessage($this->plugin->formatMessage("Your faction must have a home set before being allowed to claim land."));
			            return true;
		            }
		            ...
		            if ($this->plugin->getNumberOfPlayers($faction) < $this->plugin->prefs->get("PlayersNeededInFactionToClaimAPlot")) {
		            	$needed_players = $this->plugin->prefs->get("PlayersNeededInFactionToClaimAPlot") - $this->plugin->getNumberOfPlayers($faction);
	            ...
	            if (strtolower($args[0]) == 'plotinfo' or strtolower($args[0]) == 'pos') {
                        $x = floor($sender->getX());
                        $z = floor($sender->getZ());
	            ...
	            if (strtolower($args[0]) == "desc" or strtolower($args[0]) == "msg") {
                        if ($this->plugin->isInFaction($sender->getName()) == false) {
                            $sender->sendMessage($this->plugin->formatMessage("You must be in a faction to use this!"));
                            return true;
                        }
	            ...
	            if (strtolower($args[0]) == "del" or strtolower($args[0]) == "fdisband") {
	            ...
	            if (strtolower($args[0]) == "allywith" or strtolower($args[0]) == "ally") {
                        if (!isset($args[1])) {
	            ...
	            if (strtolower($args[0]) == "breakalliancewith" or strtolower($args[0]) == "unally") {
                        if (!isset($args[1])) {
	            ...
	            if (strtolower($args[0]) == "allyok" or strtolower($args[0]) == "aaccept") {
                        if (!$this->plugin->isInFaction($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("You must be in a faction to do this"));
                            return true;
                        }
	            ...
	            if (strtolower($args[0]) == "allyno" or strtolower($args[0]) == "aadeny") {
                        if (!$this->plugin->isInFaction($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("You must be in a faction to do this"));
                            return true;
                        }
